 ...
 * Version: 1.0.15
 * Built: Tue Aug 14 2012 09:43:58
 * http://parse.com
 *
...
(function(root) {
  ...
  Parse._encode = function(value, seenObjects) {
    ...
    if (value instanceof Parse.Object) {
      if (!seenObjects || _.include(seenObjects, value)) {
  ...
  Parse._decode = function(key, value) {
    ...
    if (!_.isObject(value)) {
      ...
      if (value.__type === "Pointer") {
        ...
        pointer._finishFetch({ objectId: value.objectId });
        return pointer;
  ...
  _.extend(Parse.Object.prototype, Parse.Events,
    ...
    fetch: function(options) {
      ...
      options.success = function(resp, status, xhr) {
        model._finishFetch(model.parse(resp, status, xhr));
        if (success) {
          success(model, resp);
        }
      };
    ...
    change: function(options) {
      ...
      this._silent = {};
      Parse._each(changes, function(attr) {
