...
function joinPlaylist(url){
	...
	query.find({
	  success: function(playlistArray) {
               ...
               $("#tracksPlaylist").append('<li data-theme="c"><a href="#" data-transition="slide" onclick="voteTrack('+id+')" >'+playlistArray[i].get("nameTrack")+'('+playlistArray[i].get("nameArtist")+') &raquo;</a> </li>');
               i++;
               }
               
               $("#tracksPlaylist").listview('refresh');
               $('#tracksPlaylist').scrollview();
...
function getPlaylists(){
	...
	query.find({
	  success: function(playlistArray) {
               ...
               $("#playlistsShowList").append('<li data-theme="c"><a href="#playlist" data-transition="slide" onclick="joinPlaylist('+url+')" >'+playlistArray[i].get("name")+' &raquo;</a> </li>');
               i++;
               }
